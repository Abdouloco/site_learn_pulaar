...
$is_draft = Helpers::has_draft( $post_id );
...
<?php if ( $is_converted ) : ?>
	...
	<p>
		<code style="display:block; border:1px solid #afafaf;border-radius: 3px;padding: 10px;color: #23282d;">[playht_listen_button]</code>
	</p>
	<p class="playht-admin-help-text ">
	...
	<?php if ( ! $is_draft ) : ?>
		<p>
			<span class="t-bottom t-lg full-width">
				<input type="button" id="playht-edit-audio" data-postid="<?php echo esc_attr( $post_id ); ?>" value="<?php esc_attr_e( 'Regenerate Audio', 'play-ht' ); ?>" class="playht-button button button-large button-secondary">
			</span>
		</p>
	<?php endif; ?>
	<p style="text-align: center;">
