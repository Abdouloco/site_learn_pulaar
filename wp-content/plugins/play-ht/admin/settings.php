...
function playHtListenButton() {
	...
	<h5 class="palyht_title_settings">Title Play Button <small>If enabled, will show a listen button below any article title, only in the article page and articles list pages.</small></h5>
	<div class="palyhtBodySettings ListenButtonClass">
	<div class="playPrivArea">
		<small>Preview</small>
		<div class="inner_playPrivArea">
			<strong>NOVEMBER 1, 2018</strong>
			<h3 class="playht_post_titleDemo">Hello world!</h3>
			...
			?>;">
				<i class="playht-icon-headphones __play-listen-floating-btn__icon"></i>
				<span class="__play-listen-btn__text">Listen</span>
			</div>
			<p class="playhtContentDemo">Welcome to WordPress. This is your first post. Edit or delete it, then start writing!</p>
		</div>
	</div>
	<?php
}
